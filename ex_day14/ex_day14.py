# with open("hello_word.txt", "w") as f:
#     f.write("Hello, World!")
# with open("hello_word.txt", "a") as f:
#     f.write("\nHow are you?")
# with open("hello_word.txt", "r") as f:
#     print(f.read())

# Lấy danh sách các từ điển mà chúng ta đã tạo từ bộ dữ liệu hoa Iris và ghi vào một tệp mới ở định dạng CSV.
irises = [
